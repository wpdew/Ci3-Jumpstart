...
<div id="top-nav" class="navbar navbar-inverse navbar-static-top">
    ...
    <!-- /container -->
		...
		<div id="body">
			...
			<p><?php echo $st_1; ?></p>
			<p><a href="<?php echo base_url(); ?>">Home</a> || <a href="<?php echo base_url('welcome'); ?>">Modules</a> || <a href="<?php echo base_url('welcome/hmvc'); ?>">Templates</a></p>
		...
		<p class="reliz"><?php echo modules::run('admin/getlast'); ?></p>
