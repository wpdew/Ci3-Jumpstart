...
<body>
	<div id="container">
		...
		<div id="body">
			<p><?php echo $st_1; ?></p>
			<p><a href="<?php echo base_url(); ?>">Home</a> || <a href="<?php echo base_url('welcome'); ?>">Modules</a> || <a href="<?php echo base_url('welcome/hmvc'); ?>">Templates</a> ||
			
			<?php if (!$this->ion_auth->logged_in()) { ?><a href="<?php echo base_url('auth/login'); ?>">Login</a> 
			<?php } else { ?> 
				<a href="<?php echo base_url('admin'); ?>">Go admin (<?php echo $this->ion_auth->user()->row()->first_name;  ?> <?php echo $this->ion_auth->user()->row()->last_name;  ?>)</a> or <a href="<?php echo base_url('auth/logout'); ?>">Logout</a>
			<?php } ?>
			
			</p>
			<p><b><?php echo $title; ?> || <?php echo $text_profile; ?> || </b>
			
			<a href="<?php echo base_url('LanguageSwitcher/switchLang/russian'); ?>">russian</a> ||
			<a href="<?php echo base_url('LanguageSwitcher/switchLang/english'); ?>">english</a> ||
			<a href="<?php echo base_url('LanguageSwitcher/switchLang/ukrainian'); ?>">ukrainian</a>
			</p>
			<p><?php echo $st_2; ?></p>
			<code>modules/admin/views/admin_message.php</code>

			<p><?php echo $st_3; ?></p>
			<code>modules/admin/controllers/Admin.php</code>
            ...
            <p>
                ...
                <b><?=$item['username'];?>: </b>  <?=$item['first_name'];?> <?=$item['last_name'];?><br />
                <?php endforeach;?>
            </p>
        </div>
