...
-->
  ...
  <div class="row" style="padding-left:15px;padding-right:15px;">  
    ...
    <h3 class="column-title"><i class="fa fa-cog fa-2x blue"> {text_install} <?php echo CMS_NAME ?>  {text_step2}</i></h3>
    ...
    <div class="account-wall" id='recovery_form' style='text-align:left; padding:0 15px;'> 
      <form class="form-horizontal" action="<?php echo base_url('install/install/upd_user')?>" method="POST">
  ...
  <div class="col-sm-12 col-xs-12 col-md-5 col-lg-5 border_gray grid_content padded background_white alert alert-warning">
      <h4 class="column-title"><i class="fa fa-cog fa-2x blue"> {text_step2}</i></h4>
      <div class="alert alert-info text-center"><b>{text_info_step2}</b></div>
    </div>
  </div>
